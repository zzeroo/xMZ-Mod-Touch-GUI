...
# define SECTION __attribute__ ((section (".gresource.xmz"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[1137]; const double alignment; void * const ptr;}  xmz_resource_data = { {
  ...
  0x71, 0x04, 0x00, 0x00, 0x2f, 0x00, 0x00, 0x00, 
...
static GStaticResource static_resource = { xmz_resource_data.data, sizeof (xmz_resource_data.data), NULL, NULL, NULL };
extern GResource *xmz_get_resource (void);
GResource *xmz_get_resource (void)
{
